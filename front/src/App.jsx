...
import TabsRender from './components/TabsRender.jsx';

function App() {
	// const [data, setData] = React.useState();
	// const scuedule_url = "https://four-seven-website-main-bdf74fbf8d75.herokuapp.com/schedule";
  // //const url = "https://four-seven-website-main-bdf74fbf8d75.herokuapp.com";

	// const GetSchedule = () => {
	// 	axios.get(scuedule_url).then((res) => {
	// 		setData(res.data);
